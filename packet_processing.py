import pyshark
import logging
from server_communication import ServerCall, Packet
from suspiciousActivity import check_sus_activity,check_unsual_port,check_unsual_traffic,check_protocol_violation,check_failed_connections_R
